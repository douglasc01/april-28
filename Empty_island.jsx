...
Command: npx gltfjsx@6.2.16 public/models/empty_island.glb -s 
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/empty_island.glb')
  return (
    <group {...props} dispose={null}>
      ...
      <group position={[-0.713, 1.138, -0.228]} rotation={[-Math.PI / 2, 0, 0]} scale={0.135}>
...
useGLTF.preload('/empty_island.glb')
